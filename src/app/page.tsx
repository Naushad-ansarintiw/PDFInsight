  ...
  return (
    <>
      <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
        ...
        <p className="mt-5 max-w-prose text-zinc-700 sm:test-lg">brandname allows you to have conversations with any PDF document. Simply upload your file and start
